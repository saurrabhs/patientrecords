...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>img/Gharada Hospital.png" />
...
<body id="page-top">
 ...
 <?php echo "<div class='alert-success text-center'>".$this->session->flashdata('sec_pass')."</div>"  ?>
  ...
  <div id="wrapper">
    ...
    <style>
        /* Define a custom gradient background color */
        .custom-bg-gradient {
            background-color: #04AA6D;
        }
    </style>
    <ul class="navbar-nav custom-bg-gradient sidenav sidebar sidebar-dark accordion" id="accordionSidebar">
