...
INSERT INTO `Status` (`c_id`, `c_name`) VALUES
(1, 'Single'),
(2, 'Married'),
(3, 'Separated');
...
INSERT INTO `patient_record` (`pr_id`, `pr_user_id`, `pr_date`, `pr_lname`, `pr_fname`, `pr_mname`, `pr_addrs`, `pr_age`, `pr_bdate`, `pr_bplace`, `pr_Status`, `pr_gen`, `pr_number`, `pr_religion`, `pr_occup`, `month`, `year`) VALUES
